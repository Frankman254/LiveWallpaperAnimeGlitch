...
export const EDITOR_THEME_CLASSES: Record<EditorTheme, EditorThemeClasses> = {
  ...
  midnight: {
    launcher: 'border border-indigo-400/28 bg-indigo-400/10 text-indigo-100 shadow-lg shadow-indigo-950/30 backdrop-blur-md',
    launcherOpen: 'bg-indigo-400/16 border-indigo-300/40',
    launcherIcon: 'text-indigo-100',
    launcherImageRing: 'ring-indigo-300/35',
    panelShell: 'bg-[#060816]/92 border border-indigo-400/18 shadow-xl shadow-indigo-950/30 backdrop-blur-md',
    panelHeader: 'border-b border-indigo-400/14 bg-indigo-950/16',
    panelTitle: 'text-indigo-100',
    panelSubtle: 'text-indigo-400/70',
    actionButton: 'border-indigo-400/20 text-indigo-100 hover:border-indigo-300 hover:text-white bg-indigo-400/[0.04]',
    tabBar: 'border-b border-indigo-400/10 bg-indigo-950/10',
    tabActive: 'bg-indigo-300 text-slate-950 font-bold border border-indigo-100/70',
    tabInactive: 'text-indigo-100/80 hover:text-white border border-transparent hover:border-indigo-300/20',
  ...
  carbon: {
    launcher: 'border border-zinc-400/25 bg-zinc-200/8 text-zinc-100 shadow-lg shadow-black/30 backdrop-blur-md',
    launcherOpen: 'bg-zinc-200/12 border-zinc-300/30',
    launcherIcon: 'text-zinc-50',
    launcherImageRing: 'ring-zinc-200/25',
    panelShell: 'bg-[#0a0a0b]/92 border border-zinc-400/14 shadow-xl shadow-black/35 backdrop-blur-md',
    panelHeader: 'border-b border-zinc-400/10 bg-zinc-900/30',
    panelTitle: 'text-zinc-100',
    panelSubtle: 'text-zinc-500',
    actionButton: 'border-zinc-400/12 text-zinc-200 hover:border-zinc-200/25 hover:text-white bg-white/[0.03]',
    tabBar: 'border-b border-zinc-400/10 bg-zinc-900/25',
    tabActive: 'bg-zinc-100 text-black font-bold border border-zinc-50/90',
    tabInactive: 'text-zinc-300 hover:text-white border border-transparent hover:border-zinc-400/15',
  ...
  aurora: {
    launcher: 'border border-teal-300/28 bg-gradient-to-br from-teal-400/10 to-violet-500/12 text-teal-50 shadow-lg shadow-violet-950/25 backdrop-blur-md',
    ...
    panelShell: 'bg-[#071211]/90 border border-teal-300/16 shadow-xl shadow-violet-950/20 backdrop-blur-md',
    panelHeader: 'border-b border-teal-300/12 bg-gradient-to-r from-teal-500/8 to-violet-500/10',
    panelTitle: 'text-teal-50',
    panelSubtle: 'text-teal-300/55',
    actionButton: 'border-teal-300/18 text-teal-50 hover:border-violet-300/28 hover:text-white bg-white/[0.03]',
    tabBar: 'border-b border-teal-300/10 bg-white/[0.02]',
    tabActive: 'bg-gradient-to-r from-teal-300 to-violet-300 text-slate-950 font-bold border border-white/50',
    tabInactive: 'text-teal-50/80 hover:text-white border border-transparent hover:border-violet-300/18',
    ...
    sectionHeader: 'border-b border-teal-300/10 bg-gradient-to-r from-teal-500/6 to-violet-500/6',
