	...
	return (
		<>
			...
			{!isRadial && store.spectrumCircularClone ? (
				<TabSection
					title={t.section_circular_clone}
					hint={t.hint_circular_clone}
				>
					<div className="flex flex-col gap-1">
						<span className="text-xs text-cyan-400">
							{t.label_clone_style}
			...
			<TabSection title={t.section_appearance}>
				...
				<div className="flex flex-col gap-1">
					...
					<EnumButtons<SpectrumColorMode>
						...
						value={store.spectrumColorMode}
						onChange={store.setSpectrumColorMode}
					/>
				</div>
				<ColorInput
					label={t.label_primary_color}
					value={store.spectrumPrimaryColor}
					onChange={store.setSpectrumPrimaryColor}
				/>
				<ColorInput
					label={t.label_secondary_color}
					value={store.spectrumSecondaryColor}
					onChange={store.setSpectrumSecondaryColor}
				/>
			</TabSection>
			...
			<TabSection title={t.section_spectrum_motion_peaks}>
				{isRadial ? (
					<SliderControl
						...
						value={store.spectrumRotationSpeed}
