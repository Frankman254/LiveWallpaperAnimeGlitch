...
import type { RainParticleType } from '@/types/wallpaper'
...
export default function RainTab({ onReset }: { onReset: () => void }) {
  ...
  return (
    <>
      ...
      <SliderControl label={t.label_rain_width} value={store.rainWidth} min={0.0005} max={0.012} step={0.0005} onChange={store.setRainWidth} />
