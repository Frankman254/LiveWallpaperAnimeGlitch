...
export const TRACK_TITLE_LAYOUTS: TrackTitleLayoutMode[] = ['free', 'centered', 'left-dock', 'right-dock']
...
export const TRACK_TITLE_FONTS: TrackTitleFontStyle[] = ['clean', 'condensed', 'techno', 'mono', 'serif']
