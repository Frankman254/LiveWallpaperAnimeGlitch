...
export function migrateWallpaperStore(persistedState: unknown): WallpaperStore {
  ...
  return {
    ...
    audioTrackTitleScanlineIntensity: state.audioTrackTitleScanlineIntensity ?? DEFAULT_STATE.audioTrackTitleScanlineIntensity,
    audioTrackTitleScanlineSpacing: state.audioTrackTitleScanlineSpacing ?? DEFAULT_STATE.audioTrackTitleScanlineSpacing,
    audioTrackTitleScanlineThickness: state.audioTrackTitleScanlineThickness ?? DEFAULT_STATE.audioTrackTitleScanlineThickness,
