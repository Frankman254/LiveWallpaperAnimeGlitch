...
export function migrateWallpaperStore(persistedState: unknown): WallpaperStore {
  ...
  return {
    ...
    backgroundImageEnabled: state.backgroundImageEnabled ?? DEFAULT_STATE.backgroundImageEnabled,
    imageOpacity: state.imageOpacity ?? DEFAULT_STATE.imageOpacity,
    globalBackgroundEnabled: state.globalBackgroundEnabled ?? DEFAULT_STATE.globalBackgroundEnabled,
    ...
    imageAudioSmoothingEnabled: state.imageAudioSmoothingEnabled ?? DEFAULT_STATE.imageAudioSmoothingEnabled,
    imageAudioSmoothing: state.imageAudioSmoothing ?? DEFAULT_STATE.imageAudioSmoothing,
    imageOpacityReactive: state.imageOpacityReactive ?? DEFAULT_STATE.imageOpacityReactive,
    imageOpacityReactiveAmount: state.imageOpacityReactiveAmount ?? DEFAULT_STATE.imageOpacityReactiveAmount,
    ...
    rgbShiftAudioSmoothingEnabled: state.rgbShiftAudioSmoothingEnabled ?? DEFAULT_STATE.rgbShiftAudioSmoothingEnabled,
    rgbShiftAudioSmoothing: state.rgbShiftAudioSmoothing ?? DEFAULT_STATE.rgbShiftAudioSmoothing,
    ...
    spectrumAudioSmoothingEnabled: state.spectrumAudioSmoothingEnabled ?? DEFAULT_STATE.spectrumAudioSmoothingEnabled,
    spectrumAudioSmoothing: state.spectrumAudioSmoothing ?? DEFAULT_STATE.spectrumAudioSmoothing,
    ...
    logoAudioSmoothingEnabled: state.logoAudioSmoothingEnabled ?? DEFAULT_STATE.logoAudioSmoothingEnabled,
    logoAudioSmoothing: state.logoAudioSmoothing ?? DEFAULT_STATE.logoAudioSmoothing,
