...
export const es: Record<TranslationKey, string> = {
  ...
  hint_mini_player_popup: 'En este navegador se usa una ventana popup de preview como respaldo. Funciona en más navegadores de escritorio, pero no es igual a un mini reproductor siempre encima.',
  ...
  pause_audio_only: 'Pausar Reactividad',
  resume_audio_only: 'Reanudar Reactividad',
  ...
  hint_pause_audio_only: 'Detiene la reproduccion/reactividad, pero deja corriendo el movimiento visual.',
