...
export const es: Record<TranslationKey, string> = {
  ...
  hint_capture_window_audio: 'Abre el selector del navegador para capturar una pestana, ventana o pantalla que incluya audio.',
  ...
  confirm_shuffle_order: '¿Mezclar el orden de las imágenes? Puedes cancelar ahora si fue un clic accidental.',
  ...
  hint_restore_default_stack: 'Restaura el orden por defecto de las capas y vuelve a activar las capas principales del fondo.',
  ...
  hint_background_motion: 'Parallax es la deriva sutil por mouse/dispositivo aplicada al stack del wallpaper. Va aqui porque mueve el fondo, no porque analice audio.',
  ...
  hint_record_preview: 'Para exportar limpio, captura esta pestaña o la ventana mini desde el selector de captura del navegador.',
  ...
  hint_mini_player_document_pip: 'El Mini Player usa Document Picture-in-Picture cuando el navegador lo soporta, dejando el wallpaper en una ventanita siempre visible.',
  hint_mini_player_popup: 'En este navegador se usa una ventana popup flotante como respaldo. Funciona en más navegadores de escritorio, pero no es igual a un mini reproductor siempre encima.',
  hint_mini_player_unavailable: 'El Mini Player no está disponible en este navegador. La pantalla completa sí debería funcionar cuando haya soporte.',
  // MP3
  ...
  hint_pause_all: 'Congela transiciones del slideshow, particulas, lluvia y movimiento impulsado por audio, sin apagar la escena.',
  hint_pause_audio_only: 'Pausa la pista cargada cuando existe, o la reactividad del audio, pero deja corriendo el movimiento visual.',
