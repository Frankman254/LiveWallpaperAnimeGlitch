...
export const es: Record<TranslationKey, string> = {
  ...
  hint_bg_zoom_audio: 'Mismo modelo de envelope que el logo: attack, release, pico/suelo adaptativo, punch. «Classic» reproduce la curva antigua fija; prueba Smooth / Punchy o ajusta sliders.',
