export const en = {
  ...
  hint_bg_zoom_audio: 'Same envelope model as the logo: attack, release, adaptive peak/floor, punch. “Classic” matches the old built-in curve; adjust sliders or try Smooth / Punchy.',
