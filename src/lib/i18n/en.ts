export const en = {
  ...
  hint_mini_player_popup: 'This browser falls back to a preview popup. It works across more desktop browsers, but it is not the same as a true always-on-top mini player.',
  ...
  pause_audio_only: 'Pause Reactivity',
  resume_audio_only: 'Resume Reactivity',
  hint_pause_all: 'Freezes slideshow transitions, particles, rain, and audio-driven motion while keeping the scene visible.',
  hint_pause_audio_only: 'Stops playback/reactivity but leaves the visual motion systems running.',
