export const en = {
  ...
  label_circular_clone: 'Logo Circular Clone',
  hint_circular_clone: 'When the main spectrum is linear, also draw a circular copy attached to the logo if the logo is enabled.',
