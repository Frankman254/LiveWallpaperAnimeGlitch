...
export function publishSpectrumDiagnosticsSlice(slice: SpectrumDiagnosticsSlice): void {
...
export function subscribeSpectrumDiagnosticsTelemetry(onStoreChange: () => void): () => void {
