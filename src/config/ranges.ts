...
export const SPECTRUM_RANGES = {
	...
	ledCellSize: { min: 0.35, max: 4, step: 0.05 },
	ledCellGap: { min: 0, max: 2, step: 0.05 },
	ledAngle: { min: -180, max: 180, step: 1 },
	...
	glowAudioAmount: { min: 0, max: 3, step: 0.05 },
	...
	/** Global gain depth: 0 = ignore envelope, 1 = cinematic, 3 = can drop to silence when Min Height is 0. */
	gainExpressiveness: { min: 0, max: 3, step: 0.05 },
	...
	/** Envelope release/drop speed after a peak. Higher = faster fall. */
	envelopeRelease: { min: 0.01, max: 2, step: 0.01 },
	...
	/** Adaptive silence floor/noise gate. Higher ignores more low-level signal. */
	envelopePeakFloor: { min: 0, max: 0.75, step: 0.01 },
...
export const PARTICLE_RANGES = {
	...
	sizeMin: { min: 1, max: 24, step: 0.5 },
	sizeMax: { min: 2, max: 36, step: 0.5 },
	opacity: { min: 0, max: 1, step: 0.05 },
	glowStrength: { min: 0, max: 1.4, step: 0.05 },
	glowReach: { min: 1, max: 3, step: 0.05 },
	glowAudioAmount: { min: 0, max: 3, step: 0.05 },
	audioSizeBoost: { min: 0, max: 8, step: 0.1 },
	audioOpacityBoost: { min: 0, max: 1, step: 0.05 },
	audioDriftAngle: { min: 0, max: 360, step: 1 },
	audioDriftAmount: { min: 0, max: 2, step: 0.01 },
	...
	depthFlowWindInfluence: { min: 0, max: 1, step: 0.01 },
