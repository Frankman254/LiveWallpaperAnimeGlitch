...
window.LWAG_TOKENS = {
  ...
  accentBg: 'color-mix(in srgb, var(--lwag-accent, #67e8f9) 14%, transparent)',
  accentBd: 'color-mix(in srgb, var(--lwag-accent, #67e8f9) 42%, transparent)',
  // Semantic
  danger:   '#ff6b6b',
  warn:     '#f7c948',
  ok:       '#4ade80',
...
window.Icons = {
  ...
  Prev:   (p) => <Icon {...p}><polygon points="19 4 9 12 19 20 19 4" fill="currentColor" stroke="none"/><rect x="5" y="4" width="2" height="16" fill="currentColor" stroke="none"/></Icon>,
  Next:   (p) => <Icon {...p}><polygon points="5 4 15 12 5 20 5 4" fill="currentColor" stroke="none"/><rect x="17" y="4" width="2" height="16" fill="currentColor" stroke="none"/></Icon>,
  ...
  Snowflake:(p) => <Icon {...p}><line x1="2" y1="12" x2="22" y2="12"/><line x1="12" y1="2" x2="12" y2="22"/><path d="M20 16l-4-4 4-4M4 8l4 4-4 4M16 4l-4 4-4-4M8 20l4-4 4 4"/></Icon>,
  ...
  Images: (p) => <Icon {...p}><rect x="3" y="3" width="14" height="14" rx="2"/><path d="M21 7v14H7"/></Icon>,
  ...
  EyeOff: (p) => <Icon {...p}><path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a21.77 21.77 0 0 1 5.06-6.06M9.9 4.24A11 11 0 0 1 12 4c7 0 11 8 11 8a21.6 21.6 0 0 1-3.17 4.49M1 1l22 22"/><path d="M14.12 14.12a3 3 0 1 1-4.24-4.24"/></Icon>,
  ...
  Dots:   (p) => <Icon {...p}><circle cx="5" cy="12" r="1.5" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.5" fill="currentColor" stroke="none"/><circle cx="19" cy="12" r="1.5" fill="currentColor" stroke="none"/></Icon>,
  ...
  Wand:   (p) => <Icon {...p}><path d="M15 4V2M15 16v-2M8 9h2M20 9h2M17.8 11.8L19 13M17.8 6.2L19 5M3 21l9-9M12.2 6.2L11 5"/></Icon>,
  ...
  Drop:   (p) => <Icon {...p}><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"/></Icon>,
  Mic:    (p) => <Icon {...p}><rect x="9" y="2" width="6" height="13" rx="3"/><path d="M19 11a7 7 0 0 1-14 0M12 18v4M8 22h8"/></Icon>,
  ...
  Minimize:(p) => <Icon {...p}><polyline points="4 14 10 14 10 20"/><polyline points="20 10 14 10 14 4"/><line x1="14" y1="10" x2="21" y2="3"/><line x1="3" y1="21" x2="10" y2="14"/></Icon>,
  ...
  Trash:  (p) => <Icon {...p}><polyline points="3 6 5 6 21 6"/><path d="M19 6l-2 14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2L5 6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></Icon>,
  ...
  Waves:  (p) => <Icon {...p}><path d="M2 6c2 0 2 2 4 2s2-2 4-2 2 2 4 2 2-2 4-2 2 2 4 2"/><path d="M2 12c2 0 2 2 4 2s2-2 4-2 2 2 4 2 2-2 4-2 2 2 4 2"/><path d="M2 18c2 0 2 2 4 2s2-2 4-2 2 2 4 2 2-2 4-2 2 2 4 2"/></Icon>,
  Circle: (p) => <Icon {...p}><circle cx="12" cy="12" r="9"/></Icon>,
  Tunnel: (p) => <Icon {...p}><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5.5"/><circle cx="12" cy="12" r="2"/></Icon>,
  Bars:   (p) => <Icon {...p}><line x1="4" y1="20" x2="4" y2="10"/><line x1="9" y1="20" x2="9" y2="4"/><line x1="14" y1="20" x2="14" y2="13"/><line x1="19" y1="20" x2="19" y2="8"/></Icon>,
  Sparkles:(p) => <Icon {...p}><path d="M12 3v4M12 17v4M3 12h4M17 12h4M5 5l3 3M16 16l3 3M5 19l3-3M16 8l3-3"/></Icon>,
  Reset:  (p) => <Icon {...p}><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></Icon>,
  Info:   (p) => <Icon {...p}><circle cx="12" cy="12" r="9"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></Icon>,
  Pin:    (p) => <Icon {...p}><path d="M12 17v5M9 3h6l-1 7 4 4H6l4-4z"/></Icon>,
  Zap:    (p) => <Icon {...p}><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" fill="currentColor" stroke="none"/></Icon>,
};

// ---- PRIMITIVES ------------------------------------------------------------

// Card / PanelSection — the foundational container
window.Card = function Card({ title, subtitle, action, children, style, padded = true, level = 1 }) {
    ...
    <div style={{
      ...
      {(title || action) && (
        <div style={{
          ...
          padding: `${T.s3}px ${T.s4}px`, borderBottom: `1px solid ${T.hairline}`,
        }}>
          <div>
            {title && <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: T.fgMute, fontFamily: T.fontMono }}>{title}</div>}
            {subtitle && <div style={{ fontSize: 13, color: T.fg, marginTop: 2 }}>{subtitle}</div>}
          </div>
          {action}
        </div>
      )}
...
window.CollapsibleGroup = function CollapsibleGroup({ title, defaultOpen = false, badge, children, dense = false }) {
  ...
  return (
    <div style={{ borderTop: `1px solid ${T.hairline}` }}>
      <button onClick={() => setOpen(!open)} style={{
        ...
        color: T.fgMute, fontSize: 11, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase',
        fontFamily: T.fontMono,
      }}>
        <span style={{ display: 'flex', alignItems: 'center', gap: T.s2 }}>
          <window.Icons.ChevR size={12} style={{ transform: open ? 'rotate(90deg)' : 'none', transition: 'transform 120ms' }} />
          {title}
          {badge && <span style={{
      ...
      {open && <div style={{ padding: `0 ${T.s4}px ${T.s4}px` }}>{children}</div>}
    </div>
  );
};

// Button
window.Button = function Button({ children, variant = 'ghost', size = 'md', icon, onClick, active, disabled, full, style }) {
  ...
  const variants = {
    ...
    ghost:   { bg: active ? T.accentBg : T.raised, fg: T.fg, bd: active ? T.accentBd : T.border },
    flat:    { bg: 'transparent', fg: T.fgMute, bd: 'transparent' },
    danger:  { bg: 'rgba(255,107,107,0.12)', fg: T.danger, bd: 'rgba(255,107,107,0.34)' },
  }[variant];
  return (
    <button onClick={onClick} disabled={disabled} style={{
      ...
      border: `1px solid ${variants.bd}`, borderRadius: T.r2,
      fontSize: sizes.fs, fontWeight: 500, fontFamily: T.fontUI,
...
window.IconButton = function IconButton({ children, onClick, active, size = 'md', title, style }) {
  ...
  return (
    <button onClick={onClick} title={title}
      ...
      style={{
        width: dim, height: dim, minWidth: 32, minHeight: 32,
        ...
        borderRadius: T.r2, cursor: 'pointer',
        transition: 'background 120ms, border-color 120ms, transform 80ms', ...style,
      }}>
      {children}
    </button>
  );
...
window.SegmentedControl = function SegmentedControl({ value, onChange, options, size = 'md', full }) {
  ...
  return (
    <div style={{
      ...
      borderRadius: T.r2, width: full ? '100%' : undefined,
    }}>
      {options.map(opt => {
        ...
        return (
          <button key={v} onClick={() => onChange(v)} style={{
            flex: full ? 1 : undefined, height: h - 4,
            padding: `0 ${icon ? 8 : 12}px`,
            display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 6,
            background: sel ? T.accent : 'transparent',
            color: sel ? '#04141a' : T.fgMute,
            border: 0, borderRadius: T.r1, cursor: 'pointer',
            fontSize: fs, fontWeight: sel ? 600 : 500,
            fontFamily: T.fontUI, whiteSpace: 'nowrap',
...
// ToggleSwitch
window.ToggleSwitch = function ToggleSwitch({ checked, onChange, size = 'md' }) {
  ...
  return (
    <button onClick={() => onChange(!checked)} style={{
      ...
      <span style={{
        position: 'absolute', top: 1, left: checked ? w - k - 3 : 1,
...
window.SliderRow = function SliderRow({ label, value, onChange, min = 0, max = 100, step = 1, unit, hint, locked, onReset }) {
  ...
  return (
    <div style={{ padding: `${T.s2}px 0` }} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
        <span style={{ fontSize: 12, color: T.fg, fontWeight: 500, display: 'flex', alignItems: 'center', gap: 6 }}>
          {label}
          {hint && <span style={{ fontSize: 10, color: T.fgFaint }}>{hint}</span>}
        </span>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          {hover && onReset && (
            <button onClick={onReset} title="Reset to default" style={{ background: 'transparent', border: 0, color: T.fgFaint, cursor: 'pointer', padding: 2 }}>
              <window.Icons.Reset size={11} />
            </button>
          )}
          <span style={{
            fontFamily: T.fontMono, fontSize: 11, fontVariantNumeric: 'tabular-nums',
            color: T.fg, background: 'rgba(0,0,0,0.32)',
            padding: '2px 8px', borderRadius: T.r1, minWidth: 48, textAlign: 'right',
            border: `1px solid ${T.border}`,
          }}>{value}{unit || ''}</span>
        </div>
      </div>
      <div
        ...
        style={{
          position: 'relative', height: 22, cursor: locked ? 'not-allowed' : 'pointer',
          opacity: locked ? 0.4 : 1,
        }}>
        <div style={{
          position: 'absolute', top: '50%', left: 0, right: 0, transform: 'translateY(-50%)',
          height: 4, background: 'rgba(0,0,0,0.42)',
...
window.Select = function Select({ value, onChange, options, full, placeholder, size = 'md' }) {
    ...
    <div ref={ref} style={{ position: 'relative', width: full ? '100%' : undefined }}>
      <button onClick={() => setOpen(!open)}
        ...
        style={{
          ...
          borderRadius: T.r2, fontSize: 13, cursor: 'pointer',
          fontFamily: T.fontUI, textAlign: 'left',
          boxShadow: open ? `0 0 0 3px ${T.accentBg}` : 'none',
          transition: 'all 120ms',
        }}>
        <span style={{ display: 'flex', alignItems: 'center', gap: 8, color: current ? T.fg : T.fgFaint, minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
          {current?.icon}
          {current?.label ?? current ?? placeholder ?? 'Select…'}
        </span>
        <span style={{
          display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
          width: 22, height: 22, borderRadius: T.r1,
          background: open ? T.accent : 'rgba(0,0,0,0.32)',
          color: open ? '#04141a' : T.fgMute,
          transition: 'all 120ms',
        }}>
          <window.Icons.ChevD size={12} style={{ transform: open ? 'rotate(180deg)' : 'none', transition: 'transform 120ms' }}/>
        </span>
      </button>
      {open && (
        <div style={{
          position: 'absolute', top: 'calc(100% + 6px)', left: 0, right: 0, zIndex: 100,
          background: T.shell, border: `1px solid ${T.borderHi}`,
          borderRadius: T.r2, padding: 4,
          ...
          {options.map((opt, i) => {
            ...
            return (
              <button key={i} onClick={() => { onChange(v); setOpen(false); }} style={{
                ...
                border: 0, borderRadius: T.r1, cursor: 'pointer',
                fontSize: 13, fontFamily: T.fontUI, textAlign: 'left',
              }}
                onMouseEnter={e => !sel && (e.currentTarget.style.background = T.hover)}
                onMouseLeave={e => !sel && (e.currentTarget.style.background = 'transparent')}>
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: sel ? T.accent : 'transparent', flexShrink: 0 }}/>
                {opt.icon}
                <span style={{ flex: 1 }}>{label}</span>
                {opt.hint && <span style={{ fontSize: 10, color: T.fgFaint, fontFamily: T.fontMono }}>{opt.hint}</span>}
              </button>
            );
          })}
        </div>
...
window.Toolbar = function Toolbar({ children, style }) {
  return (
    <div style={{
      ...
      background: T.shell,
      border: `1px solid ${T.border}`, borderRadius: T.r3,
...
window.ToolbarDivider = function ToolbarDivider() {
  return <div style={{ width: 1, alignSelf: 'stretch', background: T.hairline, margin: `0 ${T.s1}px` }}/>;
};

// Field row (label + control)
window.Field = function Field({ label, hint, children, layout = 'row' }) {
  return layout === 'row' ? (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, padding: `${T.s2}px 0` }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 6, padding: `${T.s2}px 0` }}>
      <span style={{ fontSize: 11, color: T.fgMute, fontWeight: 500, fontFamily: T.fontMono, letterSpacing: '0.04em', textTransform: 'uppercase' }}>{label}</span>
      {children}
      {hint && <span style={{ fontSize: 10, color: T.fgFaint }}>{hint}</span>}
    </div>
  );
...
window.SectionLabel = function SectionLabel({ children, action }) {
  return (
    <div style={{
      ...
      <span style={{ fontSize: 10, fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: T.fgMute, fontFamily: T.fontMono }}>
        {children}
      </span>
      {action}
    </div>
...
window.TabPill = function TabPill({ children, active, onClick, icon }) {
  return (
    <button onClick={onClick} style={{
      ...
      border: 0, borderRadius: T.r2, cursor: 'pointer',
      fontSize: 13, fontWeight: active ? 600 : 500, fontFamily: T.fontUI,
...
window.PresetChip = function PresetChip({ label, active, onClick, color, icon }) {
  return (
    <button onClick={onClick} style={{
      ...
      <div style={{
        ...
        background: color || 'linear-gradient(135deg, rgba(103,232,249,0.18), rgba(168,85,247,0.18))',
        borderRadius: T.r1,
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        color: T.fg,
      }}>{icon}</div>
      <span style={{ fontSize: 11, color: active ? T.accent : T.fg, fontWeight: 500 }}>{label}</span>
    </button>
  );
};
