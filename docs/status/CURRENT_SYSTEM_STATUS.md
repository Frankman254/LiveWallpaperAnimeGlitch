...
**As of:** `b54c51bb` (`main`) · App `0.3.0-alpha.1` · Store persist **v112**
...
| Zustand + `localStorage` persist | Stable | `STORE_PERSIST_VERSION = 112`                               |
...
| `STORE_PERSIST_VERSION`   | **112**         | Migrations in `wallpaperStoreMigrations.ts` |
