...
**As of:** `672f1ec` (`main`) · App `0.3.0-alpha.1` · Store persist **v108**
...
| Zustand + `localStorage` persist | Stable | `STORE_PERSIST_VERSION = 108`                               |
...
| `STORE_PERSIST_VERSION`   | **108**         | Migrations in `wallpaperStoreMigrations.ts` |
