...
Se conserva por la misma razón que la app sigue leyendo las claves `lwag-*`: una
identidad retirada y documentada vale más que una desaparecida. **No se
referencia desde ningún código.** Si aparece en un build, es un import viejo.

Reemplazada por `public/favicon.svg` (Vibrix Pierce).
